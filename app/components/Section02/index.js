...
export default function SectionTwo() {
  ...
  const tl = gsap.timeline({ scrollTrigger: ".txt" });

  const mainTwo = useRef();
  ...
  useGSAP(
    () => {
      ...
      tl.fromTo(
        ".crtv",
        { scrollTrigger: ".crtv", scale: 5, opacity: 0 },
        {
          scale: 1,
      ...
      tl.fromTo(
        ".tal",
        { scrollTrigger: ".tal", scale: 5, opacity: 0 },
        {
          scale: 1,
      ...
      gsap.to(".handshak", { rotate: 35, yoyo: true, repeat: -1 });
    },
  ...
  return (
    <div ref={mainTwo}>
        ...
        <div className=" containers w-full h-[100vh] ">
          <div className=" panel px-[50px] relative w-full ">
              ...
              >
                ...
                <defs>
                  <pattern
                    ...
                    height="3.22581"
                  >
                    <use xlink="#svg-noise" transform="scale(0.00645161)"></use>
                  </pattern>
                  <linearGradient
              ...
              >
                ...
                <defs>
                  <pattern
                    ...
                    height="0.403226"
                  >
                    <use transform="scale(0.000806452)"></use>
                  </pattern>
                  <radialGradient
                  ...
                  >
                    <stop stopColor="#E193FF"></stop>
                    <stop offset="0.6721" stopColor="#8E78DA"></stop>
                    <stop offset="0.7378" stopColor="#937DDB"></stop>
                    <stop offset="0.8164" stopColor="#A28BDD"></stop>
                    <stop offset="0.9014" stopColor="#BAA3E2"></stop>
                    <stop offset="0.9905" stopColor="#DBC3E7"></stop>
                    <stop offset="1" stopColor="#DFC7E8"></stop>
                  </radialGradient>
                  <radialGradient
                  ...
                  >
                    <stop stopColor="#FFE2F2"></stop>
                    <stop offset="0.609375" stopColor="#FFADDA"></stop>
                    <stop offset="0.776042" stopColor="#FF7CC5"></stop>
                    <stop offset="0.911458" stopColor="#FF71BF"></stop>
                    <stop offset="1" stopColor="#F84FAC"></stop>
                  </radialGradient>
                </defs>
              </svg>
            </span>
            <span className=" flex gap-[17px] text-[90px] font-bold text-nowrap z-10 ">
              ...
              <span className="flex">
                <p className=" crtv px-[25px] rounded-xl  ">Creative</p>
              </span>
              <span className="flex">
                <p className=" txt px-[25px] rounded-xl  ">and</p>
              </span>
              <span className="flex">
                <p className=" tal px-[25px] rounded-xl text-black ">
                  Talented
                </p>
              </span>
              <span className="flex">
                <p className=" txt px-[25px] rounded-xl ">people.</p>
              </span>
            </span>
            <span className=" purp absolute left-[2000px] -bottom-[100px] ">
              <svg
                width="52"
                height="62"
                viewBox="0 0 52 62"
              ...
              >
                ...
                <defs>
                  <pattern
                    ...
                    height="8.06452"
                  >
                    <use transform="scale(0.016129)"></use>
                  </pattern>
                  <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop offset="0.0242443" stopColor="#EDBEFF"></stop>
                    <stop offset="0.84375" stopColor="#8E78DA"></stop>
                  </linearGradient>
                </defs>
              </svg>
            </span>
            <span className=" handshak absolute left-[2500px] -top-[100px] ">
              <svg
                width="100"
                height="113"
                viewBox="0 0 100 113"
      ...
      <div className=" lg:hidden flex flex-col justify-center items-center my-[100px] gap-[25px] ">
        <div className=" circpinky ">
          <Image src="/gol.svg" width={150} height={150} alt="gol" />
        </div>
        <div className=" px-[35px] ">
          <p className=" text-[40px] font-bold text-center  ">
            You can imagine us as a community of{" "}
            <span className=" bg-[#f700ff] text-black rounded-md p-[3px] ">
              Creative
            </span>{" "}
            and{" "}
            <span className=" bg-[#ffd500] text-black rounded-md p-[3px] ">
              Talented
            </span>{" "}
            people.
          </p>
